...
@section('content')
    ...
    <div class="fixed h-[93%] w-[84%] left-[16%] top-[7%] p-12 flex flex-col">
        ...
        <div class=" h-full w-full">
            <form action="{{ route('nurseNote.update', $nurseNote->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-8 gap-2 pb-3">
                            <div class="col-span-4 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $nurseNote->patient_fullname }}" required>
                            ...
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $nurseNote->record_date['obsDate'][1] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDate[1]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="time"
                                        ...
                                        value="{{ $nurseNote->record_time['obsTime'][1] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsTime[1]')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $nurseNote->record_date['obsDate'][2] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDate[2]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="time"
                                        ...
                                        value="{{ $nurseNote->record_time['obsTime'][2] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsTime[2]')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[2]" autocomplete="off" required>{{ $nurseNote->focus['obsFocus'][2] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsFocus[2]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[2]" autocomplete="off" required>{{ $nurseNote->data_action_response['obsDar'][2] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDar[2]')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $nurseNote->record_date['obsDate'][3] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDate[3]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="time"
                                        ...
                                        value="{{ $nurseNote->record_time['obsTime'][3] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsTime[3]')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[3]" autocomplete="off" required>{{ $nurseNote->focus['obsFocus'][3] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsFocus[3]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[3]" autocomplete="off" required>{{ $nurseNote->data_action_response['obsDar'][3] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDar[3]')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $nurseNote->record_date['obsDate'][4] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDate[4]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="time"
                                        ...
                                        value="{{ $nurseNote->record_time['obsTime'][4] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsTime[4]')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[4]" autocomplete="off" required>{{ $nurseNote->focus['obsFocus'][4] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsFocus[4]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[4]" autocomplete="off" required>{{ $nurseNote->data_action_response['obsDar'][4] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDar[4]')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $nurseNote->record_date['obsDate'][5] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDate[5]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="time"
                                        ...
                                        value="{{ $nurseNote->record_time['obsTime'][5] ?? '' }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsTime[5]')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[5]" autocomplete="off" required>{{ $nurseNote->focus['obsFocus'][5] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsFocus[5]')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[5]" autocomplete="off" required>{{ $nurseNote->data_action_response['obsDar'][5] ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('obsDar[5]')
                                            {{ $message }}
                                        @enderror
