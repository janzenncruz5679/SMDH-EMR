...
<head>
    ...
    <title>{{ 'Outpatient Form ' . $outpatient_view->patient_id . '.pdf' }}</title>
    <style>
        @page {
            margin: 45px;
...
<body>
    ...
    <div class="first_section">
        <div class="visit">
            <label>DATE:
                {{ Carbon\Carbon::parse($outpatient_view->hospital_visit['visit_start']['start_date'])->format('m/d/y') }}</label><br>
            <label>TIME:
                {{ Carbon\Carbon::parse($outpatient_view->hospital_visit['visit_start']['start_time'])->format('g:i A') }}</label>
        </div>
        <div class="health_rec_no">
            <label>HEALTH RECORD NUMBER: {{ $outpatient_view->patient_id }}</label>
        </div>
    </div>
    <div class="second_section">
        ...
        <div class="patient_name">
            ...
            <div class="name_value">
                <label class="lname_value">{{ $outpatient_view->last_name }}</label>
                <label class="fname_value">{{ $outpatient_view->first_name }}</label>
                <label class="mname_value">{{ $outpatient_view->middle_name }}</label>
                <label class="suffix_value">{{ $outpatient_view->suffix }}</label>
            </div>
        </div>
        <div class="personal_info">
            ...
            <div class="address_value">
                {{ $outpatient_view->full_address['street'] }}, {{ $outpatient_view->full_address['barangay'] }}
                {{ $outpatient_view->full_address['municipality'] }}
                {{ $outpatient_view->full_address['province'] }} {{ $outpatient_view->full_address['zip_code'] }}
                {{ $outpatient_view->full_address['country'] }}
            </div>
        </div>
        <div class="personal_second">
            ...
            <div class="phone_value">
                {{ $outpatient_view->personal_info['phone'] }}
            </div>
            <div class="birthday_value">
                {{ Carbon\Carbon::parse($outpatient_view->personal_info['birthday'])->format('m/d/y') }}
            </div>
            <div class="age_value">
                {{ $outpatient_view->personal_info['age'] }}
            </div>
            <div class="status_value">
                {{ $outpatient_view->personal_info['civil_status'] }}
            </div>
            <div class="sex_value">
                {{ $outpatient_view->personal_info['gender'] }}
            </div>
        </div>
        <div class="personal_third">
            ...
            <div class="occupation_value">
                {{ $outpatient_view->personal_info['occupation'] }}
            </div>
            <div class="company_value">
                {{ $outpatient_view->personal_info['company'] }}
            </div>
        </div>
        ...
        <div class="case_summary">
            ...
            <div class="height">{{ $outpatient_view->case_summary['latest_vitals']['height'] }}</div>
            <div class="pulse">{{ $outpatient_view->case_summary['latest_vitals']['pulse_rate'] }}</div>
            <div class="weight">{{ $outpatient_view->case_summary['latest_vitals']['weight'] }}</div>
            <div class="temperature">{{ $outpatient_view->case_summary['latest_vitals']['temperature'] }}</div>
            <div class="bp">{{ $outpatient_view->case_summary['latest_vitals']['blood_pressure'] }}</div>
            <div class="rr">{{ $outpatient_view->case_summary['latest_vitals']['respiratory_rate'] }}</div>
            <div class="illness">
                <label>PRESENT ILLNESS</label>
                <div class="illness_value">{{ $outpatient_view->case_summary['present_illness'] }}</div>
            </div>
            <div class="complaint">
                <label>CHIEF COMPLAINT</label>
                <div class="complaint_value">{{ $outpatient_view->case_summary['chief_complaint'] }}</div>
            </div>
            <div class="diagnosis">
        ...
        <div class="footer">
            ...
            <div class="discharge_value">
                <label class="discharge_date_label">DATE:
                    {{ Carbon\Carbon::parse($outpatient_view->hospital_visit['visit_end']['end_date'])->format('m/d/y') }}</label><br>
                <label class="discharge_time_label">TIME:
                    {{ Carbon\Carbon::parse($outpatient_view->hospital_visit['visit_end']['end_time'])->format('g:i A') }}</label>
            </div>
            <label class="disposition">DISPOSITION</label>
            <input class="checkbox_first" type="checkbox"
                {{ $outpatient_view->case_summary['disposition'] == 'Treated and Sent Home' ? 'checked' : 'disabled' }}>
            <input class="checkbox_second" type="checkbox"
                {{ $outpatient_view->case_summary['disposition'] == 'For Admission' ? 'checked' : 'disabled' }}>
            <input class="checkbox_third" type="checkbox"
                {{ $outpatient_view->case_summary['disposition'] == 'Refused Admission' ? 'checked' : 'disabled' }}>
            <input class="checkbox_fourth" type="checkbox"
                {{ $outpatient_view->case_summary['disposition'] == 'Referred' ? 'checked' : 'disabled' }}>
            <input class="checkbox_fifth" type="checkbox"
                {{ $outpatient_view->case_summary['disposition'] == 'Out When Called' ? 'checked' : 'disabled' }}>
