        ...
        <div class=" h-full w-full">
            <form action="" method="POST" enctype="multipart/form-data" class="admission-form text-xl tracking-wider">
                ...
                <div
                    ...
                    <label>Vital Signs History Record # {{ $vitalSignHistory->id }}</label>
                </div>
                {{-- admissionform_sec --}}
                        ...
                        <div class="grid grid-cols-7 gap-2 pb-3">
                            <div class="col-span-3 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $vitalSignHistory->patient_fullname ?? '' }}" required>
                            ...
                            <div class="px-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ $vitalSignHistory->birthdate ?? '' }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('birthdate')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-span-2 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $vitalSignHistory->physician ?? '' }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('physician')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="h-full px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="doctor's note" name="notes" readonly required>{{ $vitalSignHistory->notes ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('notes')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][1] ?? '' }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][1] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][2] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][2] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][3] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][3] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][4] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][4] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][5] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][5] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][6] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][6] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][7] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][7] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][8] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][8] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][9] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][9] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][10] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][10] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][11] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][11] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][12] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][12] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][13] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][13] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][14] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][14] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][15] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][15] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][16] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][16] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][17] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][17] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][18] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][18] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][19] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][19] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="pb-3">
                            ...
                            <div class=" grid grid-cols-8 h-full w-full px-3 gap-4">
                                <div>
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $vitalSignHistory->date['dateRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Weight:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->weight['weightRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Temperature:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->temp['tempRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Blood Pressure:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->bp['bpRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pulse:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pulse['pulseRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Respiration</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->respiration['respirationRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Pain</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->pains['painRecord'][20] ?? '' }}">
                                </div>
                                <div>
                                    <label>Initials</label>
                                    <input type="text"
                                        ...
                                        value="{{ $vitalSignHistory->initials['initialsRecord'][20] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-navigation py-8 grid grid-cols-8 gap-4">
                    ...
                    <a class=" col-start-8 text-zinc-900 hover:text-white tracking-[2px] text-2xl font-[sans-serif]"
                        href="{{ route('vitalSign.show', $vitalSignHistory->history_id) }}">
                        <div
