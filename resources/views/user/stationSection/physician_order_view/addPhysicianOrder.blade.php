    ...
    <div class="grid absolute h-[94%] w-[86%] left-[275px] top-[59px] p-12">
        ...
        <div class="grid grid-rows-6 w-full">
            <div class=" h-full w-full">
                <form action="{{ route('submit_addPhysicianOrder') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="grid grid-cols-9 h-full gap-4">
                                    ...
                                    <div class="col-span-4">
                                        ...
                                        <textarea type="text"
                                            ...
                                            placeholder="focus" name="progressnotesArray[1]" autocomplete="off" value="{{ old('progressnotesArray[1]') }}"></textarea>
                                    </div>
                                    <div class="col-span-4">
                                        <label>DOCTOR'S ORDER* :</label>
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="action response" name="doctororderArray[1]" autocomplete="off"
                                            value="{{ old('doctororderArray[1]') }}"></textarea>
                                ...
                                <div class="grid grid-cols-9 h-full gap-4">
                                    <div class="grid gap-3">
                                        ...
                                        <div class="grid">
                                            ...
                                            <input type="time"
                                                class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                                name="entrytimeArray[2]" autocomplete="off"
                                                value="{{ old('entrytimeArray[2]') }}">
                                        </div>
                                    </div>
                                    <div class="col-span-4">
                                        <label>PROGRESS NOTES* :</label>
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="focus" name="progressnotesArray[2]" autocomplete="off" value="{{ old('progressnotesArray[2]') }}"></textarea>
                                    </div>
                                    <div class="col-span-4">
                                        <label>DOCTOR'S ORDER* :</label>
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="action response" name="doctororderArray[2]" autocomplete="off"
                                            value="{{ old('doctororderArray[2]') }}"></textarea>
