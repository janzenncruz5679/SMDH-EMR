        ...
        <div class=" h-full w-full">
            <form action="{{ route('editBilling', $view_bill->or_no) }}" method="POST" enctype="multipart/form-data"
                ...
                <div
                    ...
                    <label>Billing Information for {{ $view_bill->full_name }}</label>
                </div>
                {{-- admissionform_sec --}}
