<div class="w-full pb-12">
	<div class="flex items-center h-20">
		<div class="step1 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
		...
		<div class="step2 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
		...
		<div class="step3 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
		...
		<div class="step4 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
		...
		<div class="step5 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
		...
		<div class="step6 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
