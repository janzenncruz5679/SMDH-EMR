<div class="sidebar z-50 fixed w-[275px] h-screen left-0 top-[59px] bg-zinc-900">
	...
	<div class="selection list-none">
		<nav>
			<ul>
				<x-sidebar-menu :url="url('home')" :active-url="request()->routeIs('home')" text="Home" fontAwesomeIcon="fa-solid fa-house" />
				...
				<x-sidebar-menu :url="url('stations')" :active-url="request()->routeIs('stations')" text="Records" fontAwesomeIcon="fa-solid fa-notes-medical" />
