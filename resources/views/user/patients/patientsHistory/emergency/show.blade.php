        ...
        <div class=" h-full w-full">
            <form action="" method="POST" enctype="multipart/form-data" class="admission-form text-xl tracking-wider">
                ...
                <div
                    ...
                    <label>Emergency Record # {{ $emergencyHistory->patient_id }}</label>
                </div>
                            ...
                            <div class="grid grid-cols-5 h-full">
                                <div class="px-3 pb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="last name" name="last_name" value="{{ $emergencyHistory->last_name }}"
                                        readonly>
                                </div>
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->first_name }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->middle_name }}">
                            ...
                            <div class="grid grid-cols-6 h-full w-full">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->ward_room_bed_service }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['phone'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <div class="w-full">
                                        <select name="gender"
                                            ...
                                            <option value="Male"
                                                {{ $emergencyHistory->personal_info['gender'] == 'Male' ? 'selected' : '' }}>
                                                Male
                                            </option>
                                            <option value="Female"
                                                {{ $emergencyHistory->personal_info['gender'] == 'Female' ? 'selected' : '' }}>
                                                Female
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        <select name="civil_status"
                                            ...
                                            @foreach ($_civil_status as $k => $v)
                                                <option value="{{ $v }}"
                                                    {{ $emergencyHistory->personal_info['civil_status'] == $v ? 'selected' : '' }}>
                                                    {{ $k }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="grid grid-cols-6 h-full w-full">
                                <div class="px-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['birthday'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['age'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['birthplace'] }}" readonly>
                                </div>
                                <div class="px-3 ">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['religion'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['occupation'] }}">
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->personal_info['nationality'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="grid px-3 pb-3 text-2xl text-[#003D33] font-semibold tracking-widest">
                            ...
                            <div class="grid grid-cols-4 h-full">
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['street'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['barangay'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['municipality'] }}" readonly>
                                </div>
                            </div>
                            <div class="grid grid-cols-4 h-full">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['province'] }}" readonly>
                                </div>
                                <div class=" px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['region'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['zip_code'] }}" readonly>
                                </div>
                                <div class=" px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->full_address['country'] }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-4 h-full">
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_last'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_first'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    <label>MIDDLE NAME:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_middle'] }}">
                                </div>
                                <div class="px-3">
                                    <label>SUFFIX:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_suffix'] }}">
                                </div>
                            </div>
                            <div class="grid grid-cols-5 h-full">
                                <div class="col-span-2 px-3 pb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_address'] }}" readonly>
                                </div>
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_phone'] }}" readonly>
                                </div>
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergencyHistory->contact_person['contact_rtp'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="grid px-3 pb-3 text-2xl text-[#003D33] font-semibold tracking-widest">
                                ...
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $emergencyHistory->hospital_visit['visit_start']['start_date'] }}"
                                            readonly>
                                ...
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ $emergencyHistory->hospital_visit['visit_start']['start_time'] }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $emergencyHistory->hospital_visit['visit_end']['end_date'] }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ $emergencyHistory->hospital_visit['visit_end']['end_time'] }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="px-3">
                                    ...
                                    <div class="w-full">
                                        <select name="disposition"
                                            ...
                                            @foreach ($_disposition as $k => $v)
                                                <option value="{{ $v }}"
                                                    {{ $emergencyHistory->case_summary['disposition'] == $v ? 'selected' : '' }}>
                                                    {{ $k }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class=" grid grid-cols-6 h-full w-full px-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['height'] }}">
                                    </div>
                                    <div>
                                        <label>WEIGHT:</label>
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['weight'] }}"
                                            readonly>
                                    </div>
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['temperature'] }}"
                                            readonly>
                                    </div>
                                    <div>
                                        <label>PULSE:</label>
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['pulse_rate'] }}"
                                            readonly>
                                    </div>
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['blood_pressure'] }}"
                                            readonly>
                                    </div>
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $emergencyHistory->case_summary['latest_vitals']['respiratory_rate'] }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-3 gap-4 px-3">
                            <div>
                                ...
                                <textarea type="text"
                                    ...
                                    placeholder="present illness" name="present_illness" autocomplete="off" readonly>{{ $emergencyHistory->case_summary['present_illness'] }}</textarea>
                            </div>
                            <div>
                                <label>CHIEF COMPLAINT: <span class="text-red-600 font-bold">*</span></label>
                                <textarea type="text"
                                    class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="chief complaint" name="chief_complaint" autocomplete="off" readonly>{{ $emergencyHistory->case_summary['chief_complaint'] }}</textarea>
                            </div>
                            <div>
                ...
                <div class="form-navigation py-8 grid grid-cols-8 gap-4">
                    ...
                    <a class=" col-start-8 text-zinc-900 hover:text-white tracking-[2px] text-2xl font-[sans-serif]"
                        href="{{ route('emergency.show', $emergencyHistory->history_id) }}">
                        <div
