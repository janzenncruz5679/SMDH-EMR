<div class="sidebar z-50 fixed w-[275px] h-screen left-0 top-[59px] bg-zinc-900">
    ...
    <div class="selection list-none">
        <nav>
            <ul>
                <x-sidebar-menu :url="url('home')" text="Home" fontAwesomeIcon="fa-solid fa-house"></x-sidebar-menu>
                <x-sidebar-menu :url="route('patients.index')" text="Patients" fontAwesomeIcon="fa-solid fa-hospital-user">
                </x-sidebar-menu>
                <x-sidebar-menu :url="url('stations')" text="Records" fontAwesomeIcon="fa-solid fa-notes-medical">
                </x-sidebar-menu>
                <x-sidebar-menu :url="url('billing')" text="Billing" fontAwesomeIcon="fa-solid fa-hand-holding-dollar">
                </x-sidebar-menu>
            </ul>
        </nav>
    </div>
