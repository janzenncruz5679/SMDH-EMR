<div class="w-full pb-12">
    <div class="flex items-center justify-around h-20">
        ...
        <div
            class="line6 flex flex-grow shadow-md shadow-blue-200 justify-center items-center border-4 border-blue-100 w-25">
        </div>
        <div
            class="step7 shadow-md shadow-blue-200 h-full flex items-center justify-center p-6 rounded-full border-4 border-blue-100">
            <span class="check6 text-3xl font-bold ">7</span>
        </div>
    </div>
</div>
