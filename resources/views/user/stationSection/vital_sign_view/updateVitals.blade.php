                                        ...
                                        <div class="grid grid-cols-6">
                                            <div class="inline">
                                                <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                                    ...
                                                    {{ $vitals->gender == 'Male' ? 'checked' : '' }}>
                                                <label>Male</label>
                                            </div>
                                            <div class="inline col-span-2">
                                                <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                                    value="Female" name="gender"
                                                    {{ $vitals->gender == 'Female' ? 'checked' : '' }}>
                                                <label>Female</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="grid border-b-2 border-black h-full">
                                <div class="grid p-3">
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="enter doctor's note to the patient" name="notes" autocomplete="off">{{ $vitals->notes ?? 'N/A' }}</textarea>
