...
@section('content')
    ...
    <div class="fixed h-[93%] w-[84%] left-[16%] top-[7%] p-12 flex flex-col">
        ...
        <div class=" h-full w-full">
            <form action="{{ route('vitalSign.update', $vitalSign->id) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="px-3">
                                ...
                                <div class="w-full">
                                    <select name="gender"
                                        ...
                                        <option value="Male" {{ $vitalSign->gender == 'Male' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="Female" {{ $vitalSign->gender == 'Female' ? 'selected' : '' }}>
                                            Female
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="h-full px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="doctor's note" name="notes" autocomplete="off" required>{{ $vitalSign->notes ?? '' }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('notes')
                                            {{ $message }}
                                        @enderror
