                        ...
                        <div class="grid gap-2">
                            <div class="grid grid-cols-5 h-full">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="N/A if not available" name="suffix" value="{{ $outpatient->suffix }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-2 pb-3">
                            ...
                            <div class="grid grid-cols-6 h-full w-full">
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="senior citizen #" name="sr_no" value="{{ $outpatient->sr_no }}">
                    ...
                    <div class="p-4 bg-slate-200 rounded-b-3xl">
                            ...
                            <div class="grid grid-cols-4 h-full">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $outpatient->contact_person['contact_middle'] }}">
                                </div>
                                <div class="px-3">
                                    <label>SUFFIX:</label>
                                    <input type="text"
                                        ...
                                        value="{{ $outpatient->contact_person['contact_suffix'] }}">
                                </div>
                            </div>
                            <div class="grid grid-cols-5 h-full">
                        ...
                        <div class="grid grid-cols-3 gap-4 px-3">
                            ...
                            <div>
                                ...
                                <textarea type="text"
                                    class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="diagnosis" name="diagnosis" autocomplete="off" readonly>{{ $outpatient->case_summary['diagnosis'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
