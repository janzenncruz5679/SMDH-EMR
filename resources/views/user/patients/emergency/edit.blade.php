        ...
        <div class=" h-full w-full">
            <form action="{{ route('emergency.update', $emergency->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div
                    ...
                    <label>Emergency Cover Sheet {{ $emergency->patient_id }}</label>
                </div>
                            ...
                            <div class="grid grid-cols-5 h-full">
                                <div class="px-3 pb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->last_name }}" required>
                                ...
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->first_name }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('first_name')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="" name="suffix" autocomplete="off" value="{{ $emergency->suffix }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-6 h-full w-full">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="number" maxlength="5"
                                        ...
                                        value="{{ $emergency->ward_room_bed_service }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="number" maxlength="11"
                                        ...
                                        value="{{ $emergency->personal_info['phone'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('phone')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->personal_info['nationality'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('nationality')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="grid grid-cols-6 h-full w-full">
                                <div class="px-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ $emergency->personal_info['birthday'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('birthday')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->personal_info['birthplace'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('birthplace')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3 ">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->personal_info['religion'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('religion')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->personal_info['company'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-4 h-full">
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->full_address['street'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('street')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="px-3">
                                    ...
                                    {{-- <input type="text"
                                        ...
                                        value="{{ $emergency->full_address['barangay'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('barangay')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <select name="barangay" id="barangay"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        required>
                                        <option value="{{ $emergency->full_address['barangay'] }}" selected>
                                            {{ $emergency->full_address['barangay'] }}
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('barangay')
                                ...
                                <div class="px-3">
                                    ...
                                    <select name="municipality" id="municipality"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        required>
                                        <option value="{{ $emergency->full_address['municipality'] }}" selected>
                                            {{ $emergency->full_address['municipality'] }}
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('municipality')
                            ...
                            <div class="grid grid-cols-4 h-full">
                                ...
                                <div class="px-3">
                                    ...
                                    {{-- <input type="text"
                                        ...
                                        value="{{ $emergency->full_address['province'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('province')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <select name="province" id="province"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        required>
                                        <option value="{{ $emergency->full_address['province'] }}" disabled>
                                            {{ $emergency->full_address['province'] }}
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('province')
                                ...
                                <div class=" px-3">
                                    ...
                                    {{-- <input type="text"
                                        ...
                                        value="{{ $emergency->full_address['region'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('region')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <select name="region" id="region"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        required>
                                        <option value="{{ $emergency->full_address['region'] }}" disabled>
                                            {{ $emergency->full_address['region'] }}
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('region')
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $emergency->full_address['zip_code'] }}" required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('zip_code')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class=" px-3">
                                    ...
                                    <select name="country" id="country"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        required>
                                        <option value="{{ $emergency->full_address['country'] }}" disabled>
                                            {{ $emergency->full_address['country'] }}
                                        </option>
                                    </select>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('country')
                            ...
                            <div class="grid grid-cols-4 h-full">
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_last'] }}"
                                        required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('contact_last')
                                            {{ $message }}
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_first'] }}"
                                        required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('contact_first')
                                            {{ $message }}
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_middle'] }}">
                                </div>
                                <div class="px-3">
                                    <label>SUFFIX:</label>
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_suffix'] }}">
                                </div>
                            </div>
                            <div class="grid grid-cols-5 h-full">
                                <div class="col-span-2 px-3 pb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_address'] }}"
                                        required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                ...
                                <div class="px-3">
                                    ...
                                    <input type="number" maxlength="11"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_phone'] }}"
                                        required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('contact_phone')
                                            {{ $message }}
                                ...
                                <div class="col-span-2 px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $emergency->contact_person['contact_rtp'] }}"
                                        required>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('contact_rtp')
                                            {{ $message }}
                                ...
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $emergency->hospital_visit['visit_end']['end_date'] }}" required>
                                        <span class="text-base font-[sans-serif] font-medium text-red-600">
                                            @error('end_date')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="px-3">
                                    <div>
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ $emergency->hospital_visit['visit_end']['end_time'] }}" required>
                                        <span class="text-base font-[sans-serif] font-medium text-red-600">
                                            @error('end_time')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class=" grid grid-cols-6 h-full w-full px-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ $emergency->case_summary['latest_vitals']['weight'] }}">
                                    </div>
                                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4 px-3">
                            <div>
                                ...
                                <textarea type="text"
                                    ...
                                    placeholder="present illness" name="present_illness" autocomplete="off" required>{{ $emergency->case_summary['present_illness'] }}</textarea>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div>
                                ...
                                <textarea type="text"
                                    class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="chief complaint" name="chief_complaint" autocomplete="off" required>{{ $emergency->case_summary['chief_complaint'] }}</textarea>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div>
                                ...
                                <textarea type="text"
                                    class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="diagnosis" name="diagnosis" autocomplete="off" required>{{ $emergency->main_diagnosis }}</textarea>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('diagnosis')
                                        {{ $message }}
                                    @enderror
