        ...
        <div class=" h-full w-full">
            <form action="" method="POST" enctype="multipart/form-data" class="admission-form text-xl tracking-wider">
                ...
                <div
                    ...
                    <label>Fluid Intake Information # {{ $fluidIntake->id }}</label>
                </div>
                {{-- admissionform_sec --}}
                    ...
                    <div class="p-4 bg-slate-200 rounded-b-3xl">
                        ...
                        <div class="grid grid-cols-7 gap-2 pb-3">
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="last name" name="last_name" readonly value="{{ $fluidIntake->last_name }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('last_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="suffix" name="suffix" readonly value="{{ $fluidIntake->last_name }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('suffix')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidIntake->patient_info['age'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('age')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="grid grid-cols-7 gap-2 pb-3">
                            <div class="col-span-5 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidIntake->patient_info['diagnosis'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('diagnosis')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidIntake->patient_info['bed'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('bed')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidIntake->patient_info['ward'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('ward')
                                        {{ $message }}
                                    @enderror
