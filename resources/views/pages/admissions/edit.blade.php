...
@section('content')
    ...
    <div class="absolute h-[93%] w-[84%] left-[16%] top-[7%] p-12 grid grid-rows-3 ">
                                ...
                                <div class="w-full flex justify-start gap-4">
                                    ...
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            ...
                                            {{ $admission->patient->sex == 'Female' ? 'checked' : '' }}>
                                        <label>F</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-3 border-black p-3">
                                ...
                                <div class="w-full flex justify-around">
                                    ...
                                    @foreach ($_civil_status as $k => $v)
                                        <div class="inline">
                                            <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                                value="{{ $v }}" name="civil_status"
                                                {{ $admission->patient->civil_status == $v ? 'checked' : '' }}>
                                            <label>{{ $k }}</label>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="grid grid-cols-7 border-b-2 border-black h-full">
                            <div class=" border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->address['street'] }}">
                            </div>
                            <div class=" border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->address['municipality'] }}">
                            </div>
                            <div class=" border-r-2 border-black p-3">
                        ...
                        <div class="grid grid-cols-7 border-b-2 border-black h-full">
                            ...
                            <div class=" border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->patient->emergency_contact['address'] }}">
                            </div>
                            <div class=" border-r-2 border-black p-3">
                                <label>PHONE :</label>
                                <input type="text"
                            ...
                            <div class=" border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off"
                                    value="{{ $admission->patient->emergency_contact['relationship'] }}">
                            </div>
                        </div>
                                        ...
                                        <div class="grid grid-cols-4 items-center">
                                            ...
                                            <div class="col-span-3">
                                                <input type="text"
                                                    ...
                                                    value="{{ $admission->diagnosis['other_diagnosis'] }}">
                                            </div>
                                        </div>
                                        {{-- <div class="grid grid-cols-4">
                                            <span class="col-start-2 text-base font-[sans-serif] font-medium text-red-600">
