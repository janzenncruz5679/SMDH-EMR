                                ...
                                <div class="grid grid-cols-8 h-full gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea type="text"
                                            ...
                                            placeholder="focus" name="obsFocus[1]" autocomplete="off" value="{{ old('focus') }}"></textarea>
                                    </div>
                                    <div class="col-span-5">
                                        <label>DATA ACTION AND RESPONSE* :</label>
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="action response" name="obsDar[1]" autocomplete="off" value="{{ old('data_action_response') }}"></textarea>
                            ...
                            <div class="p-3 grid gap-3">
                                ...
                                <div class="grid grid-cols-8 h-full gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="focus" name="obsFocus[2]" autocomplete="off" value="{{ old('focus') }}"></textarea>
                                    </div>
                                    <div class="col-span-5">
                                        <label>DATA ACTION AND RESPONSE* :</label>
                                        <textarea type="text"
                                            class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="action response" name="obsDar[2]" autocomplete="off" value="{{ old('data_action_response') }}"></textarea>
