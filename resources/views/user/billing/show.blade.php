                                ...
                                <table class="tracking-[2px] w-full">
                                    ...
                                    <tbody class="grid gap-3">
                                        <tr class="grid grid-cols-5 gap-3 ">
                                            ...
                                            <td class="flex justify-center">
                                                <input type="number" maxlength="3" readonly
                                                    oninput="this.value=this.value.slice(0,this.maxLength)"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="medicine_qty[1]" readonly
                                    ...
                                    <tbody class="grid gap-3">
                                        ...
                                        <tr class="grid grid-cols-5 gap-3 ">
                                            <td class="col-span-2 flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="medicine_name[10]" readonly
                                    ...
                                    <tbody class="grid gap-3">
                                        ...
                                        <tr class="grid grid-cols-5 gap-3 ">
                                            <td class="col-span-2 flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="lab_procedure[10]" readonly
                                    ...
                                    <tbody class="grid gap-3">
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="xray_procedure[1]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="xray_procedure[2]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="xray_procedure[3]" readonly
                                    ...
                                    <tbody class="grid gap-3">
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="oxygen_procedure[1]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="oxygen_procedure[2]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="oxygen_procedure[3]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="oxygen_procedure[4]" readonly
                                        ...
                                        <tr class="grid grid-cols-4 gap-3 ">
                                            <td class="flex justify-center">
                                                <input type="text"
                                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2 text-center"
                                                    name="oxygen_procedure[5]" readonly
