...
<head>
    ...
    <title>{{ $pdf_dischargesummary->patients_identity }} Discharge Summary Info</title>
    <style>
        @page {
            margin: 20px 45px;
...
<body>
    ...
    <div class="date_value">
        {{ $pdf_dischargesummary->discharge_date ?? '' }}
    </div>
    ...
    <div class="doctor_value">
        {{ $pdf_dischargesummary->doctor_name ?? '' }}
    </div>
    <div class="license_value">
        {{ $pdf_dischargesummary->license_number ?? '' }}
    </div>
</body>
