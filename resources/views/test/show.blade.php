...
@section('content')
    ...
    <div class="addPatient absolute top-[59px] left-[275px] h-full w-[85.3vw] p-12 ">
        ...
        <div class=" h-full w-full">
            <form action="{{ url('/patientPage/editAdmission' . $admission->id) }}" method="POST" class="admission-form"
                        ...
                        <div class="grid grid-cols-8 border-b-2 border-black h-full">
                            <div class="col-span-5 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->address }}">
                            ...
                            <div class="col-span-3 p-3">
                                ...
                                <input type="text"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="enter latest record #" autocomplete="off" value="{{ $admission->id }}"
                                    readonly>
                        ...
                        <div class="grid grid-cols-8 border-b-2 border-black h-full">
                            <div class="col-span-3 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->sr_no ?? 'N/A' }}">
                        ...
                        <div class="grid grid-cols-12 border-b-2 border-black h-full">
                            ...
                            <div class="col-span-2 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->lnamename ?? 'N/A' }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('last_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-span-3 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->fname ?? 'N/A' }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('first_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-span-3 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->mname ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->ward_room_bed_service ?? 'N/A' }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                        ...
                        <div class="grid grid-cols-11 border-b-2 border-black h-full">
                            ...
                            <div class="col-span-2 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->contact_num }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600" autocomplete="off">
                                    @error('phone')
                                        {{ $message }}
                                    @enderror
                                ...
                                <div class="w-full flex justify-start gap-4">
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            ...
                                            {{ $admission->patient->sex == 'Male' ? 'checked' : '' }}>
                                        <label>M</label>
                                    </div>
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Female"
                                            name="gender"{{ $admission->patient->sex == 'Female' ? 'checked' : '' }}>
                                        <label>F</label>
                                    </div>
                                ...
                                <div class="w-full flex justify-around">
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            ...
                                            {{ $admission->patient->civil_status == 'Single' ? 'checked' : '' }}>
                                        <label>S</label>
                                    </div>
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Divorced" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Divorced' ? 'checked' : '' }}>
                                        <label>D</label>
                                    </div>
                                    <div class="col-span-2 inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Separated" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Separated' ? 'checked' : '' }}>
                                        <label>SEP</label>
                                    </div>
                                    <div class="col-span-2 inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Common Law" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Common Law' ? 'checked' : '' }}>
                                        <label>C</label>
                                    </div>
                                    <div class="col-span-2 inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Widowed" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Widowed' ? 'checked' : '' }}>
                                        <label>W</label>
                                    </div>
                                    <div class="col-span-2 inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Married" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Married' ? 'checked' : '' }}>
                                        <label>M</label>
                                    </div>
                                    <div class="col-span-2 inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Neutral" name="civil_status"
                                            {{ $admission->patient->civil_status == 'Neutral' ? 'checked' : '' }}>
                                        <label>N</label>
                                    </div>
                                </div>
                                <span class="text-base font-[sans-serif] font-medium text-red-600" autocomplete="off">
                        ...
                        <div class="grid grid-cols-11 border-b-2 border-black h-full">
                            ...
                            <div class="col-span-2 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->birthplace }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('birthplace')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-span-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->occupation ?? 'N/A' }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-9 border-b-2 border-black h-full">
                            ...
                            <div class="col-span-3 border-r-2 border-black flex flex-col items-center p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['employer']['address'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-black flex flex-col items-center p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['employer']['contact'] ?? 'N/A' }}">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-9 border-b-2 border-black full">
                            <div class="col-span-3 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['father']['name'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-r-2 border-black flex flex-col items-center p-3">
                                <p>ADDRESS</p>
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['father']['address'] ?? 'N/A' }}">
                            </div>
                            <div
                                class="col-span-3
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['father']['contact'] ?? 'N/A' }}">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-9 border-b-2 border-black h-full">
                            <div class="col-span-3 border-r-2 border-black flex flex-col items-start p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['mother']['name'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-r-2 border-black flex flex-col items-center p-3">
                                <p>ADDRESS</p>
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['mother']['address'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-black flex flex-col items-center p-3">
                                <p>TEL. NO.</p>
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['mother']['contact'] ?? 'N/A' }}">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-9 border-b-2 border-black h-full">
                            <div class="col-span-3 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['spouse']['name'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-r-2 border-black flex flex-col items-center p-3">
                                <p>ADDRESS</p>
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['spouse']['address'] ?? 'N/A' }}">
                            </div>
                            <div class="col-span-3 border-black flex flex-col items-center p-3">
                                <p>TEL. NO.</p>
                                <input type="text"
                                    ...
                                    value="{{ $admission->patient->relatives['spouse']['contact'] ?? 'N/A' }}">
                            </div>
                        </div>
                        {{-- empty border --}}
                        <div class="border-b-2 border-black h-8"></div>
                                ...
                                <div class="w-full flex justify-start gap-10">
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            ...
                                            {{ $admission->type == 'New' ? 'checked' : '' }}>
                                        <label>New</label>
                                    </div>
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Old" name="admission_type"
                                            {{ $admission->type == 'Old' ? 'checked' : '' }}>
                                        <label>Old</label>
                                    </div>
                                    <div class="inline">
                                        <input class="scale-150 cursor-pointer accent-blue-300" type="radio"
                                            value="Former OPD" name="admission_type"
                                            {{ $admission->type == 'Former OPD' ? 'checked' : '' }}>
                                ...
                                <div class=" col-span-5 grid grid-cols-6">
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="a" name="ssc" {{ $admission->ssc == 'a' ? 'checked' : '' }}>
                                        <label>A</label>
                                    </div>
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="b" name="ssc" {{ $admission->ssc == 'b' ? 'checked' : '' }}>
                                        <label>B</label>
                                    </div>
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="c_one" name="ssc"
                                            {{ $admission->ssc == 'c_one' ? 'checked' : '' }}>
                                        <label>C1</label>
                                    </div>
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="c_two" name="ssc"
                                            {{ $admission->ssc == 'c_two' ? 'checked' : '' }}>
                                        <label>C2</label>
                                    </div>
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="c_three" name="ssc"
                                            {{ $admission->ssc == 'c_three' ? 'checked' : '' }}>
                                        <label>C3</label>
                                    </div>
                                    <div class="flex justify-center gap-2">
                                        <input class="scale-125 cursor-pointer accent-blue-300" type="radio"
                                            value="d" name="ssc" {{ $admission->ssc == 'd' ? 'checked' : '' }}>
                                        <label>D</label>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-12 border-b-2 border-black h-full">
                            <div class="col-span-2 border-r-2 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->alergy }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="col-span-4 border-r-2 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->insurance['name'] }}">
                            </div>
                            <div class="col-span-3 border-r-2 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->insurance['name'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="col-span-3 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->insurance['type'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                        ...
                        <div class="grid grid-cols-12 border-b-2 border-black h-full">
                            <div class="col-span-6 border-r-2 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->data_origin['from'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('furnished_by')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-span-3 border-r-2 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ $admission->data_origin['address'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="col-span-3 border-black p-3 gap-2">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $admission->data_origin['relation'] }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        ...
                                        <div class="grid grid-cols-4 items-center">
                                            ...
                                            <div class="col-span-3">
                                                <input type="text"
                                                    ...
                                                    value="{{ $admission->additional_diagnosis['principal_diagnosis'] }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-4 items-center">
                                            ...
                                            <div class="col-span-3">
                                                <input type="text"
                                                    ...
                                                    value="{{ $admission->additional_diagnosis['other_diagnosis'] }}">
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-4">
                                            <span class="col-start-2 text-base font-[sans-serif] font-medium text-red-600">
                                        ...
                                        <div class="grid grid-cols-5 items-center">
                                            ...
                                            <div class="col-span-3">
                                                <input type="text"
                                                    ...
                                                    value="{{ $admission->additional_operation_procedure['principal_operation'] }}">
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-5">
                                        ...
                                        <div class="grid grid-cols-5 items-center">
                                            ...
                                            <div class="col-span-3">
                                                <input type="text"
                                                    ...
                                                    value="{{ $admission->additional_operation_procedure['other_operation'] }}">
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-5">
                                            <span class="col-start-3 text-base font-[sans-serif] font-medium text-red-600">
