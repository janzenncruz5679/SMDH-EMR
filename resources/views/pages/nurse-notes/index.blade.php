...
@section('content')
    ...
    @endphp
    <div class="fixed h-[93%] w-[84%] left-[16%] top-[7%] p-12 text-2xl font-[sans-serif]">
        <div class="h-16 w-full z-0">
            ...
            <div class="admissionDisplay w-full relative pt-4 -z-10">
                ...
                <div class="admissionTable pt-[5px]">
                    {{-- route('patients.nurse-notes.index') --}}
                    @if ($_routeIsIndex)
                                    ...
                                    <tr class="  even:bg-gray-200 odd:bg-white text-xl text-center">
                                        ...
                                        <td class="">
                                            <div class="flex gap-4">
                                                ...
                                                <a href="{{ route('viewpdfNurseNotes', ['id' => $nurseNote->id]) }}"
                    ...
                    @else
                        {{-- route('records.nurse-notes.index') --}}
                        <table class="tracking-[2px] w-full table-auto">
                            <thead>
                                <tr class="">
                                    <th class="shrink"></th>
                            ...
                            <tbody class="">
                                @forelse ($nurseNotes as $nurseNote)
                                    <tr class="  even:bg-gray-200 odd:bg-white text-xl text-center">
                                        <td class="shrink">{{ $loop->iteration }}</td>
                                        <td class="">{{ $nurseNote->ward_room }}</td>
                                        <td class="">{{ $nurseNote->patient->full_name }}</td>
                                        <td class="">
                                            <div class="flex gap-4">
                                                <a href="{{ route('records.nurse-notes.show-all', [$nurseNote->patient->id, $nurseNote->ward_room]) }}"
                                                    class="editIcon hover:text-blue-300">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                                {{-- <a href="{{ route('updateNurseNotes', ['id' => $nurseNote->id]) }}" class="editIcon hover:text-blue-300">
