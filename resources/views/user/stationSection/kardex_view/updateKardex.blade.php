    ...
    <div class="grid absolute h-[94%] w-[86%] left-[275px] top-[59px] p-12">
        ...
        <div class="grid grid-rows-6 w-full">
            <div class=" h-full w-full">
                <form action="{{ route('editKardex', ['id' => $kardex->id]) }} }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-section">
                            ...
                            <div class="grid grid-cols-12 h-full ">
                                <div class="col-span-2 border-r-2 border-black p-3">
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="date_of_admission" autocomplete="off"
                                        value="{{ $kardex->date_of_admission }}">
                                    {{-- <span class="text-base font-[sans-serif] font-medium text-red-600">
                                            @error('patient_fullname')
                                                {{ $message }}
                                            @enderror
