        ...
        <div class=" h-full w-full">
            <form action="" method="POST" enctype="multipart/form-data" class="admission-form text-xl tracking-wider">
                ...
                <div
                    ...
                    <label>Nurse Note History Record #{{ $nurseNoteHistory->id }}</label>
                </div>
                {{-- admissionform_sec --}}
                        ...
                        <div class="grid grid-cols-8 gap-2 pb-3">
                            <div class="col-span-4 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $nurseNoteHistory->patient_fullname }}" readonly>
                            </div>
                            <div class="col-span-2 px-3">
                                <label>AGE* :</label>
                                <input type="text"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="Patient Age" name="age" value="{{ $nurseNoteHistory->age }}" readonly>
                                </span>
                            </div>
                            <div class="col-span-2 px-3">
                                <label>WARD* :</label>
                                <input type="text"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    placeholder="Ward #" name="ward" value="{{ $nurseNoteHistory->ward }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsDate[1]" value="{{ $nurseNoteHistory->record_date['obsDate'][1] ?? '' }}"
                                        readonly>
                                </div>
                                <div>
                                    <label>TIME* :</label>
                                    <input type="time"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsTime[1]" value="{{ $nurseNoteHistory->record_time['obsTime'][1] ?? '' }}"
                                        readonly>
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="focus" name="obsFocus[1]" readonly>{{ $nurseNoteHistory->focus['obsFocus'][1] ?? '' }}</textarea>
                                </div>
                                <div>
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[1]" readonly>{{ $nurseNoteHistory->data_action_response['obsDar'][1] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsDate[2]" value="{{ $nurseNoteHistory->record_date['obsDate'][2] ?? '' }}"
                                        readonly>
                                </div>
                                <div>
                                    <label>TIME* :</label>
                                    <input type="time"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsTime[2]" value="{{ $nurseNoteHistory->record_time['obsTime'][2] ?? '' }}"
                                        readonly>
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[2]" readonly>{{ $nurseNoteHistory->focus['obsFocus'][2] ?? '' }}</textarea>
                                </div>
                                <div>
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[2]" readonly>{{ $nurseNoteHistory->data_action_response['obsDar'][2] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class=" grid px-3 pb-3 text-2xl text-[#003D33] font-semibold tracking-wider">
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsDate[3]" value="{{ $nurseNoteHistory->record_date['obsDate'][3] ?? '' }}"
                                        readonly>
                                </div>
                                <div>
                                    <label>TIME* :</label>
                                    <input type="time"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsTime[3]" value="{{ $nurseNoteHistory->record_time['obsTime'][3] ?? '' }}"
                                        readonly>
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[3]" readonly>{{ $nurseNoteHistory->focus['obsFocus'][3] ?? '' }}</textarea>
                                </div>
                                <div>
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[3]" readonly>{{ $nurseNoteHistory->data_action_response['obsDar'][3] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsDate[4]" value="{{ $nurseNoteHistory->record_date['obsDate'][4] ?? '' }}"
                                        readonly>
                                </div>
                                <div>
                                    <label>TIME* :</label>
                                    <input type="time"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsTime[4]"
                                        value="{{ $nurseNoteHistory->record_time['obsTime'][4] ?? '' }}" readonly>
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[4]" readonly>{{ $nurseNoteHistory->focus['obsFocus'][4] ?? '' }}</textarea>
                                </div>
                                <div>
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[4]" readonly>{{ $nurseNoteHistory->data_action_response['obsDar'][4] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class=" grid px-3 pb-3 text-2xl text-[#003D33] font-semibold tracking-wider">
                            ...
                            <div class="grid grid-cols-6 h-full gap-4 px-3">
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsDate[5]"
                                        value="{{ $nurseNoteHistory->record_date['obsDate'][5] ?? '' }}" readonly>
                                </div>
                                <div>
                                    <label>TIME* :</label>
                                    <input type="time"
                                        class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        name="obsTime[5]"
                                        value="{{ $nurseNoteHistory->record_time['obsTime'][5] ?? '' }}" readonly>
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[5]" readonly>{{ $nurseNoteHistory->focus['obsFocus'][5] ?? '' }}</textarea>
                                </div>
                                <div>
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[5]" readonly>{{ $nurseNoteHistory->data_action_response['obsDar'][5] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-navigation py-8 grid grid-cols-8 gap-4">
                    ...
                    <a class=" col-start-8 text-zinc-900 hover:text-white tracking-[2px] text-2xl font-[sans-serif]"
                        href="{{ route('nurseNote.show', $nurseNoteHistory->history_id) }}">
                        <div
