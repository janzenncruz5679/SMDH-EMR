                        ...
                        <div class="grid grid-cols-7 gap-2 pb-3">
                            <div class="col-span-2 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->first_name }}" required>
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->last_name }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('last_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->patient_info['age'] }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('age')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="grid grid-cols-7 gap-2 pb-3">
                            <div class="col-span-5 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->patient_info['diagnosis'] }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('diagnosis')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->patient_info['bed'] }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('bed')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $fluidintakes->patient_info['ward'] }}" required>
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('ward')
                                        {{ $message }}
                                    @enderror
