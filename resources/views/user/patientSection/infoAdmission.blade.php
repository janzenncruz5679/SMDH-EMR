                                ...
                                <div class="w-full flex flex-col items-end gap-4">
                                    <div class="flex">
                                        ...
                                        <input type="date"
                                            ...
                                            autocomplete="off" value="{{ $view_fourth->start_date }}" readonly>
                                    </div>
                                    <div class="flex">
                                ...
                                <div class="text-[1.3rem] w-full flex flex-col items-end gap-[20px]">
                                    <div class="flex">
                                        ...
                                        <input type="date"
                                            ...
                                            id="end_date" value="{{ $view_fourth->end_date }}" readonly>
                                    </div>
                                    <div class="flex">
                                        <label class="pt-[3px]">Time: </label>
                                        <input type="time"
                                            ...
                                            id="end_time" value="{{ $view_fourth->end_time }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-3 border-r-2 border-black px-3 py-2">
                        ...
                        <div class="grid grid-cols-2 border-b-2 border-black h-[100px]">
                            <div class="border-r-2 border-black px-3 py-2">
                                ...
                                <input type="text"
                                    ...
                                    id="admitting_clerk" value="{{ $view_fourth->admitting_clerk }}" readonly>
                            </div>
                        ...
                        <div class="grid grid-cols-2 border-b-2 border-black h-[100px]">
                            <div class="border-r-2 border-black px-3 py-2">
                                ...
                                <input type="text"
                                    ...
                                    id="admission_type" value="{{ $view_fourth->admission_type }}" readonly>
                            </div>
                            <div class="border-black px-3 py-2">
                                <p>REFERRED BY:</p>
                                <input type="text"
