...
<head>
    ...
    <title>Admission_details_{{ $admission_view->patient_id }}</title>
    <style>
        @page {
            margin: 20px;
...
<body>
    ...
    <div class="address">
        ADDRESS: {{ $admission_view->full_address['street'] }} {{ $admission_view->full_address['barangay'] }}
        {{ $admission_view->full_address['municipality'] }}
        {{ $admission_view->full_address['province'] }}
        {{ $admission_view->full_address['country'] }}
        {{ $admission_view->full_address['zip_code'] }}
    </div>
    <div class="health_rec">
        HEALTH REC NO.: {{ $admission_view->patient_id }}
    </div>
    <div class="sr_no">
        SR CITIZEN NO.: {{ $admission_view->personal_info['sr_no'] }}
    </div>
    <div class="ccc" style="font-size: 1.2rem;">
        CLINICAL COVER SHEET
    </div>
    <div class="old_health">
        OLD HEALTH RECORD NO.:{{ $admission_view->patient_id }}
    </div>
    ...
    <div class="gender_input">
        <input class="" type="checkbox" value="Male" name="gender"
            {{ $admission_view->personal_info['gender'] == 'Male' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="gender_input_two">
        <input class="" type="checkbox" value="Female" name="gender"
            {{ $admission_view->personal_info['gender'] == 'Female' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_single">
        <input class="" type="checkbox" value="Single" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Single' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_divorced">
        <input class="" type="checkbox" value="Divorced" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Divorced' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_separated">
        <input class="" type="checkbox" value="Separated" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Separated' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_commonlaw">
        <input class="" type="checkbox" value="Common Law" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Common Law' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_widowed">
        <input class="" type="checkbox" value="Widowed" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Widowed' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_married">
        <input class="" type="checkbox" value="Married" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Married' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="civil_neutral">
        <input class="" type="checkbox" value="Neutral" name="gender"
            {{ $admission_view->personal_info['civil_status'] == 'Neutral' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="birthdate_value">
        {{ $admission_view->personal_info['birthday'] }}
    </div>
    ...
    <div class="age_value">
        {{ $admission_view->personal_info['age'] }}
    </div>
    ...
    <div class="birthplace_value">
        {{ $admission_view->personal_info['birthplace'] }}
    </div>
    ...
    <div class="nationality_value">
        {{ $admission_view->personal_info['nationality'] }}
    </div>
    ...
    <div class="religion_value">
        {{ $admission_view->personal_info['religion'] }}
    </div>
    ...
    <div class="occupation_value">
        {{ $admission_view->personal_info['occupation'] }}
    </div>
    ...
    <div class="employer_name_value">
        {{ $admission_view->patient_affiliate['employer']['name'] ?? '' }}
    </div>
    <div class="employer_address">
        ADDRESS:
    </div>
    <div class="employer_address_value">
        {{ $admission_view->patient_affiliate['employer']['address'] ?? '' }}
    </div>
    ...
    <div class="employer_phone_value">
        {{ $admission_view->patient_affiliate['employer']['contact'] ?? '' }}
    </div>
    ...
    <div class="father_name_value">
        {{ $admission_view->patient_affiliate['father']['name'] ?? '' }}
    </div>
    ...
    <div class="father_address_value">
        {{ $admission_view->patient_affiliate['father']['address'] ?? '' }}
    </div>
    ...
    <div class="father_phone_value">
        {{ $admission_view->patient_affiliate['father']['contact'] ?? '' }}
    </div>
    ...
    <div class="mother_maiden_name_value">
        {{ $admission_view->patient_affiliate['mother']['name'] ?? '' }}
    </div>
    ...
    <div class="mother_address_value">
        {{ $admission_view->patient_affiliate['mother']['address'] ?? '' }}
    </div>
    ...
    <div class="mother_phone_value">
        {{ $admission_view->patient_affiliate['mother']['contact'] ?? '' }}
    </div>
    ...
    <div class="spouse_name_value">
        {{ $admission_view->patient_affiliate['spouse']['name'] ?? '' }}
    </div>
    ...
    <div class="spouse_address_value">
        {{ $admission_view->patient_affiliate['spouse']['address'] ?? '' }}
    </div>
    ...
    <div class="spouse_phone_value">
        {{ $admission_view->patient_affiliate['spouse']['contact'] ?? '' }}
    </div>
    ...
    <div class="admission_start_date">
        DATE: {{ $admission_view->hospital_visit['admission_start']['start_date'] }}
    </div>

    <div class="admission_start_time">
        TIME: {{ $admission_view->hospital_visit['admission_start']['start_time'] }}
    </div>
    ...
    <div class="discharge_end_date">
        DATE: {{ $admission_view->hospital_visit['admission_end']['end_date'] }}
    </div>

    <div class="discharge_end_time">
        TIME: {{ $admission_view->hospital_visit['admission_end']['end_time'] }}
    </div>
    ...
    <div class="admitting_physician_value">
        {{ $admission_view->admitting_personel['admitting_physician'] }}
    </div>
    ...
    <div class="admitting_clerk_value">
        {{ $admission_view->admitting_personel['admitting_clerk'] }}
    </div>
    ...
    <div class="toa_new">
        <input class="" type="checkbox" value="New" name="admission_type"
            {{ $admission_view->type_of_admission == 'New' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="toa_old">
        <input class="" type="checkbox" value="Old" name="admission_type"
            {{ $admission_view->type_of_admission == 'Old' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="toa_former">
        <input class="" type="checkbox" value="Former OPD" name="admission_type"
            {{ $admission_view->type_of_admission == 'Former OPD' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="referred_by_value">
        {{ $admission_view->admitting_personel['referred_by'] }}
    </div>
    ...
    <div class="ssc_a">
        <input class="" type="checkbox" value="a" name="ssc"
            {{ $admission_view->ssc == 'a' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="ssc_b">
        <input class="" type="checkbox" value="b" name="ssc"
            {{ $admission_view->ssc == 'b' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="ssc_c_one">
        <input class="" type="checkbox" value="c_one" name="ssc"
            {{ $admission_view->ssc == 'c_one' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="ssc_c_two">
        <input class="" type="checkbox" value="c_two" name="ssc"
            {{ $admission_view->ssc == 'c_two' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="ssc_c_three">
        <input class="" type="checkbox" value="c_three" name="ssc"
            {{ $admission_view->ssc == 'c_three' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="ssc_d">
        <input class="" type="checkbox" value="d" name="ssc"
            {{ $admission_view->ssc == 'd' ? 'checked' : 'disabled' }}>
    </div>
    ...
    <div class="hosp_plan_value">
        {{ $admission_view->insurance['hospitalization_plan'] }}
    </div>
    ...
    <div class="health_insurance_value">
        {{ $admission_view->insurance['health_insurance'] }}
    </div>
    ...
    <div class="toi_value">
        {{ $admission_view->insurance['coverage_insurance'] }}
    </div>
    ...
    <div class="data_furnished_value">
        {{ $admission_view->contact_person['contact_first'] }}
        {{ $admission_view->contact_person['contact_middle'] }}
        {{ $admission_view->contact_person['contact_last'] }}
        {{ $admission_view->contact_person['contact_suffix'] }}
    </div>
    ...
    <div class="address_informant_value">
        {{ $admission_view->contact_person['contact_address'] }}
    </div>
    ...
    <div class="rtp_value">
        {{ $admission_view->contact_person['contact_rtp'] }}
    </div>
    ...
    <div class="principal_diagnosis_value">
        {{ $admission_view->diagnosis['principal_diagnosis'] }}
    </div>
    ...
    <div class="other_diagnosis_value">
        {{ $admission_view->diagnosis['other_diagnosis'] }}
    </div>
    ...
    <div class="principal_operation_value">
        {{ $admission_view->other_opt['principal_operation'] }}
    </div>
    ...
    <div class="other_operation_value">
        {{ $admission_view->other_opt['other_operation'] }}
    </div>
    ...
    <div class="icpm_code_value">
        {{ $admission_view->icpm_code }}
    </div>

    <div class="created_at">
        000122{{ $admission_view->patient_id }}{{ $admission_view->created_at }}
    </div>
</body>
