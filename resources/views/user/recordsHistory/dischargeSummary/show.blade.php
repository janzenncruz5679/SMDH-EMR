            ...
            <form action="" method="POST" enctype="multipart/form-data" class="admission-form text-xl tracking-wider">
                        ...
                        <div class="grid grid-cols-6 gap-2 pb-3">
                            <div class="col-span-2 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $dischargeSummaryHistory->patients_identity }}">
                            ...
                            <div class=" px-3">
                                ...
                                <input type="date"
                                    class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                    name="discharge_date" readonly value="{{ $dischargeSummaryHistory->discharge_date }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="col-span-2 px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $dischargeSummaryHistory->doctor_name }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                                    @error('doctor_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="px-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $dischargeSummaryHistory->license_number }}">
                                <span class="text-base font-[sans-serif] font-medium text-red-600">
                            ...
                            <div class="grid grid-cols-3 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="doctor findings" name="positive_finding" readonly>{{ $dischargeSummaryHistory->positive_finding }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="doctor treatment" name="treatment" readonly>{{ $dischargeSummaryHistory->treatment }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('treatment')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="hospital stay" name="course_in_hospital" readonly>{{ $dischargeSummaryHistory->course_in_hospital }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('hospital stay')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="grid gap-2 pb-3">
                            <div class="grid grid-cols-2 gap-4 px-3">
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="final diagnosis" name="final_diagnosis" readonly>{{ $dischargeSummaryHistory->final_diagnosis }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('positive_finding')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <textarea type="text"
                                        class="w-full resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="plan" name="plan" readonly>{{ $dischargeSummaryHistory->plan }}</textarea>
                                    <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('plan')
                                            {{ $message }}
                                        @enderror
                ...
                <div class="form-navigation py-8 grid grid-cols-8 gap-4">
                    <a class=" col-start-8 text-zinc-900 hover:text-white tracking-[2px] text-2xl font-[sans-serif]"
                        href="{{ route('dischargeSummary.show', $dischargeSummaryHistory->history_id) }}">
                        <div
