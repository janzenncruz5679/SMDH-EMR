                                ...
                                <div class=" grid grid-cols-6 h-full w-full px-3 gap-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="height" name="height" autocomplete="off" required
                                            value="{{ old('height') }}">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="weight" name="weight" autocomplete="off" required
                                            value="{{ old('weight') }}">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="temperature" name="temperature" autocomplete="off" required
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            class="w-full h-10 border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                            placeholder="pulse rate" name="pulse_rate" autocomplete="off" required
                                    ...
                                    <div>
                                        ...
                                        <input type="text" maxlength="7"
                                            ...
                                            required value="{{ old('blood_pressure') }}">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            required value="{{ old('respiratory_rate') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
