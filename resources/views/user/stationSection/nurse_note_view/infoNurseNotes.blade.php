            ...
            <div class=" h-full w-full">
                        ...
                        <div class="grid grid-cols-8 border-b-2 border-black h-full">
                            <div class="col-span-4 border-r-2 border-black p-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $nursenotes->patient_fullname }}">
                            ...
                            <div class="grid grid-cols-8 h-full gap-4">
                                <div class="grid gap-3">
                                    <div class="grid">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $nursenotes->record_date['obsDate'][1] ?? '' }}">
                                    </div>
                                    {{-- <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('patient_fullname')
                                            {{ $message }}
                                    ...
                                    <div class="grid">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ $nursenotes->record_time['obsTime'][1] ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    ...
                                    <textarea type="text"
                                        ...
                                        placeholder="focus" name="obsFocus[1]" autocomplete="off" readonly>{{ $nursenotes->focus['obsFocus'][1] ?? '' }}</textarea>
                                </div>
                                <div class="col-span-5">
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[1]" autocomplete="off" readonly>{{ $nursenotes->data_action_response['obsDar'][1] ?? '' }}</textarea>
                                ...
                                <div class="grid gap-3">
                                    <div class="grid">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $nursenotes->record_date['obsDate'][2] ?? '' }}">
                                    </div>
                                    {{-- <span class="text-base font-[sans-serif] font-medium text-red-600">
                                        @error('patient_fullname')
                                            {{ $message }}
                                    ...
                                    <div class="grid">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ $nursenotes->record_time['obsTime'][2] ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    <label>FOCUS* :</label>
                                    <textarea type="text"
                                        class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="focus" name="obsFocus[2]" autocomplete="off" readonly>{{ $nursenotes->focus['obsFocus'][2] ?? '' }}</textarea>
                                </div>
                                <div class="col-span-5">
                                    <label>DATA ACTION AND RESPONSE* :</label>
                                    <textarea type="text"
                                        class="w-full h-[82%] resize-none border-4 border-blue-300 focus:border-blue-200 focus:outline-blue-200 px-[10px] focus:outline-offset-2"
                                        placeholder="action response" name="obsDar[2]" autocomplete="off" readonly>{{ $nursenotes->data_action_response['obsDar'][2] ?? '' }}</textarea>
                ...
                <div class="py-8 grid grid-cols-8 gap-4">
                    <a class=" col-end-7 text-zinc-900 hover:text-white tracking-[2px] text-2xl font-[sans-serif]"
                        href="{{ route('updateNurseNotes', ['id' => $nursenotes->id]) }}">
                        <div
